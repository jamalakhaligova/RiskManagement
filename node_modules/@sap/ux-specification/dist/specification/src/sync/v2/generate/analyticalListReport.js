...
function getLineItemAndChartAnnotation(v2Page, uIAnnotations, logger) {
    const qualifier = v2Page?.component?.settings?.qualifier; // qualifier from the manifest (if it has been configured)
    ...
    visualizations.some(function (visualization) {
        lineItemName = lineItemName || retrieveNameWithoutVocabulary(types_2.FacetBase.LineItem, visualization);
        chartName = chartName || retrieveNameWithoutVocabulary(types_2.FacetBase.Chart, visualization);
