...
class MtxExtensionBuildPlugin extends InternalBuildPlugin {
    ...
    async build() {
        ...
        if (model) {
            ...
            // perform SQL backend validation to prevent extension deployment problems later on
            // REVISIT: disabled - causing stack overflow errors in LinkedCSN for some scenarios
